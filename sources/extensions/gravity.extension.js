import {EVENT_TYPES, EventGravityAnalog, EventGravityDigital, INPUT_CODES, Vector3} from '../index.js';
...
const $GRAVITY_DIRECTIONS = [
    ...
    [INPUT_CODES.GRAVITY.DIRECTION_X_NEGATIVE, INPUT_CODES.GRAVITY.DIRECTION_X_POSITIVE],
    [INPUT_CODES.GRAVITY.DIRECTION_Y_NEGATIVE, INPUT_CODES.GRAVITY.DIRECTION_Y_POSITIVE],
    [INPUT_CODES.GRAVITY.DIRECTION_Z_NEGATIVE, INPUT_CODES.GRAVITY.DIRECTION_Z_POSITIVE]
];
